  ...
  return (
    <div key={type} className="mb-2">
      <Button
        ...
        className="text-foreground-muted hover:text-foreground hover:bg-hover flex w-full cursor-pointer items-center gap-2 rounded-sm border-0 bg-transparent px-3 py-3 text-left text-sm font-semibold capitalize transition-colors"
        ...
        <div className="mt-1 space-y-0.5 pl-3">
          {items.map((value) => {
            ...
            return (
              <li
                key={value.name}
                className="text-foreground dark:text-foreground-muted hover:text-foreground hover:bg-hover group mb-1 flex cursor-move items-center justify-between rounded-sm py-3 pr-3 pl-3 text-sm transition-colors"
