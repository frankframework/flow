...
function AdapterListItem({ name, adapterPosition, onOpenInStudio }: AdapterListItemProps) {
  return (
    <li className="border-border bg-background flex items-center rounded border px-2 py-1 shadow-sm">
      ...
      {/* Button – 1/3 */}
      <button
        className="text-foreground hover:bg-hover ml-2 flex w-1/3 items-center justify-center gap-1 rounded px-2 py-1 text-xs font-medium transition hover:cursor-pointer"
