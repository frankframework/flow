...
import { fetchDirectoryByPath, fetchProjectTree } from '~/services/file-tree-service'
...
export interface AdapterItemData {
  adapterName: string
  configPath: string
...
export type StudioItemData = FileItemData | AdapterItemData
