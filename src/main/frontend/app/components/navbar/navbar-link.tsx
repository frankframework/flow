  ...
  return (
    <li className="m-0 list-none p-0">
      <button
        type="button"
        onClick={handleClick}
        className={clsx('group relative flex w-full flex-col items-center p-4 text-center hover:cursor-pointer', !isActive && 'hover:bg-hover')}
      >
        <div
        ...
        <span
          className={clsx(
            'bg-backdrop text-foreground border-border absolute top-1/2 left-full z-10 ml-2 hidden -translate-y-1/2 rounded border px-2 py-1 text-sm whitespace-nowrap shadow-md group-hover:block',
          )}
        >
          {label}
        </span>
