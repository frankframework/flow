...
export default function Navbar(): JSX.Element {
  return (
    <nav className="border-border flex h-screen w-20 shrink-0 flex-col items-center justify-between gap-20 border-r py-4">
      <div className="flex w-full flex-col items-center">
        <FfIcon className="h-auto w-12" />
        <div className="text-xl font-bold">Flow</div>
      </div>
      <ul className="flex w-full flex-col">
        <NavbarLink route="configurations" label="Configuration Overview" Icon={ProjectsIcon} />
