import type { Attribute, ElementClass, ElementProperty, EnumValue, FFDocJson } from './frankdoc.types'

export interface InheritedParentElementProperties<T> {
  parentElementName: string
  properties: Record<string, T>
}

interface InheritedPropertiesExtras {
