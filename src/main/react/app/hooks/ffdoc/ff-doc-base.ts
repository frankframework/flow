import type { ElementInfo, FFDocJson } from './frankdoc.types'
import { addInheritedPropertiesToElement, type ElementClassWithInheritedProperties } from './frankdoc.utilities'
