...
public class FileController {
	...
	@GetMapping()
	public ResponseEntity<FileDTO> getFile(@PathVariable String projectName, @RequestParam String path) throws IOException {
	...
	@DeleteMapping()
	public ResponseEntity<Void> deleteFile(@PathVariable String projectName, @RequestParam String path) throws IOException {
